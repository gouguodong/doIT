...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>frontstage/js/search/search.js"></script>
	</head>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div id="courseList" class="row">
							<c:forEach items="${pageBean.recordList }" var="course">
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="course-item">
										<div class="list-img">
											<img width="280" height="160" alt="${course.courseName }" src="${course.courseIndex }">									
										</div>
										<h5><span>${course.courseName }</span></h5>
										<div class="intro">
											<p>${course.courseAd }</p>
											<span class="l">更新至${course.updateTo }</span> 
											<span class="r">课程时长：${course.courseTime }</span>
										</div>
										<div class="tips">
											<span class="l">${course.updateTime }天前更新</span> 
											<span class="r">${course.studyNumber }人学习</span>
										</div>
									</div>
								</div>
							 </c:forEach>
