...
<head>
<meta charset="utf-8">
<title>爱智网 - ${sessionScope.user.userName }正在学的课程</title>
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<%=basePath%>frontstage/css/public/userInfo2.css" />
...
<script type="text/javascript"
	src="<%=basePath%>frontstage/js/public/usertest.js"></script>
<script type="text/javascript"
	src="<%=basePath%>frontstage/js/public/userInfo-finish.js"></script>
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				<div class="panel panel-default" id="userleft">
					<div class="panel-heading space-tabs-menu">
						<span class="fa fa-trash-o pull-right"></span> <a
							class="btn btn-danger trash-complete pull-right">完成</a> <!-- <a
							class="course-checkbox pull-right" data-checked="0">不显示0进度课程</a> -->
						<ul class="myspace-tab-list">
							<li><a href="<%=basePath%>usercourse/attention.action">关注</a>
							</li>
							<li class="active"><a
								href="<%=basePath%>usercourse/learning.action">在学</a>
							</li>
							<li><a href="<%=basePath%>usercourse/learned.action">学完</a>
							</li>
						</ul>
								...
								<ul class="course-list-new clearfix">
									...
									<c:forEach items="${onestudy.usercourseVOs }" var="onecourse">
										...
										<input type="hidden" value="${onecourse.relationId}"
											name="relationId" class="rId" /> <a
											class="fa fa-close img-circle del-btn"></a> <a
											href="course/courseinfoUI.action?courseId=${onecourse.courseVO.courseId }" title="${onecourse.courseVO.courseName }">
												<div class="course-list-img">
													<img src="<%=basePath %>${onecourse.courseVO.courseIndex}">
													<div class="pro-bg"></div>
													<span class="dot-progress">${onecourse.learnpercent}%</span>

													<span class="fa fa-heart-o font-size-24"></span> <span
														class="fa fa-heart font-size-24 hide"></span>

												</div>
												<div class="progress progress-striped active studyrate">
													<div class="progress-bar progress-bar-success studyrate"
														role="progressbar" aria-valuenow="45" aria-valuemin="0"
														aria-valuemax="100" style="width: 100%">
														<span class="sr-only">${onecourse.learnpercent}%
															Complete</span>
													</div>
												</div>
												...
												<div class="intro">
													...
													<span class="pull-left">总课时:${
														onecourse.courseVO.courseTime}</span> <span class="pull-right">${onecourse.courseVO.studyNumber}人学习</span>
												</div>
												<div class="tips">
													<span class="pull-left">${onecourse.studyTime}学习</span> <span
														class="pull-right">${onecourse.courseVO.updateTime}已更新</span>
												</div> </a></li>
									</c:forEach>
								</ul>
							</c:forEach>
					...
					<div class="panel-footer">
						...
						<nav>
							...
							<ul class="pagination">
								...
								<li><a
									href="<%=basePath %>usercourse/learning.action?currentPage=${studys.beginPageIndex }">首页</a>
								</li>
								...
								<c:if test="${studys.currentPage-1>=1}">
									<li><a
										href="<%=basePath %>usercourse/learning.action?currentPage=${studys.currentPage-1}"
										aria-label="Previous"> <span aria-hidden="false">上一页</span>
									</a></li>
								</c:if>
								...
								<c:forEach var="page" begin="${studys.beginPageIndex}"
									...
									<c:if test="${page==studys.currentPage }">
										<li class="active"><a
											href="<%=basePath %>usercourse/learning.action?currentPage=${page}">${page}</a>
										</li>
									</c:if>
									<c:if test="${page!=studys.currentPage }">
										<li><a
								...
								<li><a
									href="<%=basePath %>usercourse/learning.action?currentPage=${studys.endPageIndex}">尾页</a>
								</li>
			...
			<div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
				<div class="panel panel-default" id="userright">
					...
					<div class="panel-body">
						<h4 class="myname">${sessionScope.user.userName}</h4>
					...
					<div class="panel-footer">
						<div class="mp-item">
							<span class="mp-title">经验</span> <span class="mp-num">${rightVO.userExp
								}</span>
						</div>
					</div>
				</div>
				<div class="panel panel-default space-data">
					<ul class="list-group">
						<li class="list-group-item"><span class="fa fa-clock-o"></span>学习：${rightVO.studyTime
							}小时</li>
						<li class="list-group-item"><span class="fa fa-book"></span>已学：
							<a href="<%=basePath %>usercourse/learned.action" class="countCourse"><em>${rightVO.studyCourse }</em>门课程</a></li>
						<li class="list-group-item"><span
							class="fa fa-question-circle"></span> 提问：<a
							href="<%=basePath%>userpost/quePost.action">${rightVO.postNumber
								}条</a></li>
						<li class="list-group-item"><span class="fa fa-comment-o"></span>
							回答：<a href="<%=basePath%>userreply/myReply.action">${rightVO.replyNumber
								}条</a></li>
						<!-- <li class="list-group-item">
						  	<span class="fa fa-pencil"></span>
						  	笔记：<a href="#" class="countNote"><em>0</em>条</a>
						  </li> -->
						<li class="list-group-item"><span class="fa fa-code"></span>
							代码：<a href="<%=basePath%>usercode/userCode.action">${rightVO.codeNumber
								}条</a></li>
					</ul>
				</div>
			</div>
