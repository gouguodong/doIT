		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-xs-12" style="width: 22%;" id="sidebar">
				<ul class="list-group">
				  ...
				  <li class="list-group-item active"><a href="javascript:void(0)">修改密码</a></li>
				</ul>
				<div class="sidebar-sign" style="top:0px"></div>
			</div>
			<div class="col-lg-8 col-md-8 col-xs-12" id="content">
				<div class="setting-right-wrap wrap-boxes settings row">
					<form id="frmupdatePwd" class="form-horizontal" action="javascript:updatePwd()">
					  <div class="form-group">
					    <label for="oldPwd" class="col-sm-2 control-label">当前密码</label>
					    <div class="col-sm-9">
					      <input type="password" class="form-control" name="oldPwd" id="oldPwd" placeholder="请输入当前密码">
					    </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9">
					      <input type="password" class="form-control" name="confirm" id="confirm" placeholder="请输入确认密码">
					    </div>
					    <div class="col-sm-1"></div>
					  </div>
					  <div class="form-group">
