					...
					<div class="panel panel-default video-list">
						<div class="panel-heading">
							<ul class="nav nav-tabs">
								<li class="active"><a class="ui-tabs-active" id="learnOn"
						...
						<div class="panel-body">
							<div class="list-group">
								<c:forEach items="${course.sections }" var="section">
									<div href="#" class="list-group-item mopen">
										<div class="item-parent">
											<span class="fa fa-star-o fa-2x"></span> <span
												class="article-title">${section.sectionName }</span>
										</div>
										<div class="list-group item-childs">
											<c:forEach items="${section.voides }" var="video">
												<a href="<%=basePath%>video/index.action?voideId=${video.voideId}&courseId=${course.courseId}" class="list-group-item"> <span
													class="fa fa-youtube-play"></span>&nbsp;${video.voideCode
													}&nbsp;${video.voideName } (${video.videoTimeStr }) </a>
											</c:forEach>
										</div>
									</div>
								</c:forEach>
