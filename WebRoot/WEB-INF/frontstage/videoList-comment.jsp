					...
					<div class="panel panel-default video-comment">
						<div class="panel-heading">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a id="commentOn"
							...
							<div id="_commentcon">
								<s:iterator value="recordList" status="stat">
									...
									<div class="media-left">
										<a href="friendIndex/index.action?id=${user.userId }"> <img class="media-object img-circle"
										...
										<div class="media-bottom">
											...
											<c:choose>
												<c:when test="${hasAgree[stat.index] }">
													<span class="fa fa-thumbs-up zan active" data-id="${commentId}">${agreeNumber }</span>	
												</c:when>
												<c:otherwise>
													<span class="fa fa-thumbs-up zan" data-id="${commentId}">${agreeNumber }</span>
												</c:otherwise>
											</c:choose>
						...
						<div class="panel-footer">
							...
							<s:form action="/videoList/comment.action?courseId=%{course.courseId}" id="pageForm"></s:form>
							<!-- 分页结束  -->
						</div>
					</div>
				</div>
