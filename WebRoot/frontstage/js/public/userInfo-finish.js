$(function() {
	...
	$("#userleft .fa-trash-o").click(function() {
		...
		$(".del-btn").click(function(){
			 ...
			 var deltype;
			 if($(".myspace-tab-list").children(".active").children("a").html()=="在学"){
				 deltype=1;
			 }else if($(".myspace-tab-list").children(".active").children("a").html()=="学完"){
				 deltype=2;
			 }
			 $.ajax({
				 url:"usercourse/dellearn.action",
				 data:"relationId="+relationId+"&&deltype="+deltype,
					type:"post",
					dataType : "json",
